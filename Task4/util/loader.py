...
import codecs
import unicodedata
from util.utils import create_dico, create_mapping, zero_digits
from util.utils import iob2, iob_iobes
...
def update_tag_scheme(sentences, tag_scheme):
    ...
    for i, s in enumerate(sentences):
        ...
        if not iob2(tags):  #Check that tags have a valid IOB format.
